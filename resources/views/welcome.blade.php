...
<head>
    ...
    <title>SafeHost - Create a custom hosts file</title>
...
<div class="text-center mb-5">
    <h1 class="fw-bold text-primary">SafeHost</h1>
    <p class="lead">
        ...
        <br>
        <span class="text-success fw-semibold">The purpose of SafeHost is to help people like me avoid unwanted traffic, distractions,
...
<footer class="text-center mt-5 text-muted small">
    &copy; {{ date('Y') }} SafeHost Project — created to protect and simplify browsing.
</footer>
